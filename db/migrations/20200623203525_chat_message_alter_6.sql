...
CHANGE `type` `type` enum('message','system','document','doctor_detail', 'clinic_detail', 'pay_detail', 'product_detail', 'medcard_detail', 'order_detail', 'promocode_link', 'product_link', 'notice')
